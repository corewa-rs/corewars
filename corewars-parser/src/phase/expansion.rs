...
mod test {
    ...
    fn collects_label_offset() {
        ...
        assert_eq!(
            labels,
            hashmap! {
                String::from("foo") => AbsoluteOffset(1),
                String::from("bar") => AbsoluteOffset(1),
            }
        );
    }
